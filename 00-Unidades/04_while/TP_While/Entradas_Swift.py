...
Al finalizar la carga, el programa debera mostrar los siguientes informes:
    ...
    #!X 5) - El nombre y la edad de la persona que pagó una entrada de tipo "General" y pagó
    #!          con tarjeta de débito (Solo la primera que se encuentre)
    #!X 6) - La cantidad de personas que compraron entradas de tipo "Platea" y cuya 
    #!          edad es un número primo.
    #!X 7) - Calcula el monto total recaudado por la venta de entradas de tipo "Platea" y 
...
class App(customtkinter.CTk):
    ...
    def btn_mostrar_iteracion_on_click(self):
        ...
        primer_general_debito = True
        nobre_primer_general_debito = ""
        edad_primer_general_debito = 0

        contador_platea_edad_primo = 0
        bandera_divisor = True

        contador_recaudado_primo = 0
            ...
            match medio_pago:
                ...
                case "Debito":
                    ...
                    if entrada == "Platea":
                        ...
                        if edad % 6 == 0:
                            contador_recaudado_primo += precio_ubicacion - (precio_ubicacion * porcentaje_descuento) // 100

                    if primer_general_debito == True and entrada == "General": #Gracias a la bandera no se vuelve a preguntar
                        nobre_primer_general_debito = nombre
                        edad_primer_general_debito = edad
                        primer_general_debito = False
        ...
        #! 5) - El nombre y la edad de la persona que pagó una entrada de tipo "General" y pagó
        #!          con tarjeta de débito (Solo la primera que se encuentre)
        print(f"\n5) La primera persona que compro una entrada general y pago con debito se llama {nobre_primer_general_debito} y tiene {edad_primer_general_debito} años")

        #! 6) - La cantidad de personas que compraron entradas de tipo "Platea" y cuya 
        #!          edad es un número primo.
        print(f"\n6) Las personas que compraron en Platea y su edad es un numero primo fueron: {contador_platea_edad_primo}")
        
        
        #7) - Calcula el monto total recaudado por la venta de entradas de tipo "Platea" y 
        #!    pagadas con tarjeta de debito por personas cuyas edades son múltMaiplos de 6.
        print(f"\n7) El monto total recaudado por vender en Platea con Debito y que la edad sea multiplo de 6 es de ${contador_recaudado_primo}")
        pass
